...
# Installation
 ...
 ## Command Line Tools
 1. Create a new conda environment on the command line:
...
**Input** - [Sequence files (fasta)](tools/assign_clades/test-data/input_fasta.fasta), [clade definition file (csv)](tools/assign_clades/test-data/clades.csv)  
**Output** - fasta
...
**Input** - Antigenic Site Extraction output (fasta) [(e.g. Flu A/H3 antigenic sites)](tools/linelisting/test-data/fluA_H3_clade_assigned_antigenic_sites_extracted.fasta), reference strain (fasta), amino acid index array (csv) [(e.g. Flu A/H3 index array](tools/linelisting/test-data/FluA_H3_antigenic_aa_indices.csv), [clade definition file (csv)](tools/linelisting/test-data/Flu_Clade_Definitions_H3_20171121.csv)  
**Output** - csv
